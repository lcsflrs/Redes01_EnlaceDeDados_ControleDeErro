...
* Ultima alteracao: 20 de agosto de 2021                                           *
* Funcao: Simular a Transmissao e Recepcao de Dados                                *
********************************************************************************** */

/* *********************************************************************************
* Classe: Principal                                                                *
* Funcao: Implementar os metodos que simulam as fases da tranmissao e recepcao     *
* dos dados pela camada fisica e enquadramento na camada de enlace de dados        *
********************************************************************************** */
...
public class Principal {
  ...
  public static int[] CamadaDeEnlaceTransmissoraEnquadramentoViolacaoCamadaFisica(int quadro[]) {
    // System.out.println("Entrou na Violacao da Camada Fisica");
    ArrayList<Integer> quadroEnquadrado = new ArrayList<Integer>();
    for (int i = 0; i < quadro.length; i++) {
      if (i == 0) {
        // System.out.println("i = 0");
        quadroEnquadrado.add(1);
        quadroEnquadrado.add(1);
        quadroEnquadrado.add(quadro[i]);
        // System.out.print(quadro[i]);
      } else {
  ...
  public static void CamadaFisicaTransmissora(int bits[]) { // Inicio da Camada Fisica Transmissora
    ...
    // System.out.println("Camada Fisica Transmissora Antes do Enquadramento: ");
    ...
    if (tipoDeEnquadramento == 3) {
      fluxoBrutoDeBits = CamadaDeEnlaceTransmissoraEnquadramentoViolacaoCamadaFisica(fluxoBrutoDeBits);
    }
  ...
  public static void CamadaFisicaReceptora(int fluxoBrutoDeBits[]) {
    // System.out.println("Chegou na cadama Fisica Receptora");
    if (tipoDeEnquadramento == 3) {
      // System.out.println("Enquadramento = 3");
      fluxoBrutoDeBits = CamadaDeEnlaceReceptoraEnquadramentoViolacaoCamadaFisica(fluxoBrutoDeBits);
    }
  ...
  public static int[] CamadaEnlaceDadosReceptoraEnquadramentoContagemDeCaracteres(int[] quadros) {
    ...
    while (contador < quadros.length) {
      ...
      if (caracterDeContagem == "") {
        ...
        // System.out.println("\nInteiro de Contagem: " +
        // Integer.parseInt(caracterDeContagem, 2));
  ...
  public static int[] CamadaEnlaceDadosReceptoraEnquadramentoInsercaoDeBytes(int[] quadros) {
    ...
    // System.out.println("\n\nQuadros na Recepcao Enquadramento Insercao de
    // Bytes:");
    // for (int i = 0; i < quadros.length; i++) {
    // if ((i) % 8 == 0) {
    // System.out.print(" ");
  ...
  public static int[] CamadaDeEnlaceReceptoraEnquadramentoViolacaoCamadaFisica(int quadros[]) {
    ArrayList<Integer> quadrosDesenquadrado = new ArrayList<Integer>();

    for (int i = 0; i < quadros.length; i += 2) {
      if (quadros[i] != 1 || quadros[i + 1] != 1) {
        quadrosDesenquadrado.add(quadros[i]);
        quadrosDesenquadrado.add(quadros[i + 1]);
      }
    }
