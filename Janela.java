...
/* *********************************************************************************
* Classe: Principal                                                                *
* Funcao: Implementar a classe Janela implementando a GUI                          *
********************************************************************************** */
...
public class Janela extends JFrame {
  ...
  public Janela() {
    ...
    legenda = new JLabel("F - Flag     E - Escape");
    legenda.setSize(120, 29);
    legenda.setLocation(382, 0);
    painel.add(legenda);
